...
class Bbcode implements IParser
{
    /**
     * @var int
     */
     ...
     * @return string
     */
    private function mycode_handle_size($size, $text)
    {
        $size = (int)$size + 10;
        if ($size > 50) {
            $size = 50;
     ...
     * @return string
     */
    private function mycode_handle_size_callback($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_quotes($message, $text_only = false)
    {
     ...
     * @return string
     */
    private function mycode_parse_post_quotes($message, $username, $text_only = false)
    {
        $linkback = $date = "";
     ...
     * @return string
     */
    private function mycode_parse_post_quotes_callback1($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_post_quotes_callback2($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_code($code, $text_only = false)
    {
     ...
     * @return string
     */
    private function mycode_parse_code_callback($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_php($str, $bare_return = false, $text_only = false)
    {
     ...
     * @return string
     */
    private function mycode_parse_php_callback($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_url($url, $name = "")
    {
     ...
     * @return string
     */
    private function mycode_parse_url_callback1($matches)
    {
        if (!isset($matches[3])) {
            $matches[3] = '';
        }
     ...
     * @return string
     */
    private function mycode_parse_url_callback2($matches)
    {
        if (!isset($matches[2])) {
            $matches[2] = '';
        }
     ...
     * @return string
     */
    private function mycode_parse_img($url, $dimensions = array(), $align = '')
    {
        $url = trim($url);
        $url = str_replace("\n", "", $url);
     ...
     * @return string
     */
    private function mycode_parse_img_callback1($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_callback2($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_callback3($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_callback4($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_disabled($url)
    {
        $url = trim($url);
        $url = str_replace("\n", "", $url);
        $url = str_replace("\r", "", $url);
        $url = str_replace("\'", "'", $url);
        $image = trans('parser::parser.posted_image', ['alt' => $this->mycode_parse_url($url)]);
        return $image;
    }
     ...
     * @return string
     */
    private function mycode_parse_img_disabled_callback1($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_disabled_callback2($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_disabled_callback3($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_img_disabled_callback4($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_email($email, $name = "")
    {
        if (!$name) {
            $name = $email;
        }
     ...
     * @return string
     */
    private function mycode_parse_email_callback($matches)
    {
        if (!isset($matches[2])) {
            $matches[2] = '';
        }
     ...
     * @return string
     */
    private function mycode_parse_video($video, $url)
    {
     ...
     * @return string
     */
    private function mycode_parse_video_callback($matches)
    {
     ...
     * @return string
     */
    private function mycode_parse_video_disabled($url)
    {
        $url = trim($url);
        $url = str_replace("\n", "", $url);
        $url = str_replace("\r", "", $url);
        $url = str_replace("\'", "'", $url);
        $video = trans('parser::parser.posted_video', ['alt' => $this->mycode_parse_url($url)]);
        return $video;
    }
     ...
     * @return string
     */
    private function mycode_parse_video_disabled_callback($matches)
    {
     ...
     * @return string
     */
    private function mycode_auto_url($message)
    {
        $message = " " . $message;
     ...
     * @return string
     */
    private function mycode_auto_url_callback($matches)
    {
        $external = '';
     ...
     * @return string
     */
    private function mycode_parse_list($message, $type = "")
    {
     ...
     * @return string
     */
    private function mycode_parse_list_callback($matches)
    {
     ...
     * @return string
     */
    private function mycode_prepare_list($matches)
    {
